    ...
    for event in pygame.event.get():
        ...
        #Om de game echt te kunnen spelen
            ...
            if event.key == pygame.K_SPACE:
                #De dobbelstenen
                worp1 = random.randint(1,1)
                worp2 = random.randint(1,1)
                ...
                #Bepalen over er iemand heeft gewonnen
                    ...
                    winaarknop = tk.Button(startscherm, text=f"De winnaar is {spelers[beurt]}",width=80, height=16, command=close).place(x=175, y=275)
                    gewonnen = True
